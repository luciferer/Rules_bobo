...
!(async () => {
  ...
  for await (let [y, x] of body.entries()) {
    ...
    if (/\s((request|response)-body-(json-(add|del|replace)|replace-regex))\s/.test(x)) {
      ...
      const jsurl = 'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/Script-Hub/JS/scripts/body-rewrite.js'
...
function getQxReInfo(x, y, mark) {
  ...
  let jsurl = /header/.test(hdorbd)
    ? 'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/Script-Hub/JS/scripts/replace-header.js'
    : 'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/Script-Hub/JS/scripts/replace-body.js'
  ...
  switch (targetApp) {
    ...
    case 'stash-stoverride':
      ...
      if (m2rType == null && mocktype == 'file') {
        ...
        jsurl = 'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/Script-Hub/JS/scripts/echo-response.js'
