...
vidSheepUpdateButton.addEventListener('click', function () {
    fetch(`https://v.qq.com/sheep/VidSheep/api/?update=20250608`)
...
confirmAI.addEventListener('click', () => {
    const actionHandlers = {
        'clear-AI': () => {
            ...
            fetch(`https://v.qq.com/sheep/VidSheep/api/?clearAI=${selectedCount}`)
                .then(response => response.json())
                .then(data => {
        ...
        'modify-wallpaper': () => {
            ...
            if (selectedImg) {
                fetch(`https://v.qq.com/sheep/VidSheep/api/?wallpaper=${selectedImg.src}`)
                    .then(response => response.json())
                    .then(data => {
                        console.log(data.data.information);
                    })
        ...
        'default-source': () => {
            ...
            if (selectedSourceElement) {
                ...
                fetch(`https://v.qq.com/sheep/VidSheep/api/?defaultSource=${selectedSourceValue}`)
                    .then(response => response.json())
                    .then(data => {
                        console.log(data.data.information);
                    })
...
playToolbarButtonCollect.addEventListener('click', function () {
    ...
    if (searchDataItem) {
        ...
        // 发送收藏请求
        fetch(`https://v.qq.com/sheep/VidSheep/api/?collect=${playPopupH2Text}&state=add`)
            .then(response => response.json())
            .then(data => {
                console.log(data.data.information);
            })
...
/*搜索历史处理------------------------@000006*/
// 获取历史搜索关键词,打开页面即执行
fetch('https://v.qq.com/sheep/VidSheep/api/?keywords=all')
    .then(response => response.json())
    .then(data => {
...
clearHistory.addEventListener('click', () => {
    fetch('https://v.qq.com/sheep/VidSheep/api/?keywords=clear')
        .then(response => response.json())
        .then(data => {
            console.log(data.data.information);
...
function search(sourceValue, searchWord) {
    ...
    fetch(`https://v.qq.com/sheep/VidSheep/api/?search=${sourceValue}&searchword=${encodeURIComponent(searchWord)}`)
        .then(response => response.json())
        .then(data => {
...
clearHistoryList.addEventListener('click', () => {
    ...
    fetch('https://v.qq.com/sheep/VidSheep/api/?deleteRecent=all')
        .then(response => response.json())
...
fetch('https://v.qq.com/sheep/VidSheep/api/?recent=all')
    .then(response => response.json())
    .then(data => {
        console.log(data);
        searchData = data;
...
// 获取收藏数据，首次打开执行
fetch('https://v.qq.com/sheep/VidSheep/api/?collect=all')
    .then(response => response.json())
    .then(data => {
        console.log(data);
        collectData = data;
...
playerUnity.forEach(item => {
    item.addEventListener('click', (e) => {
        ...
        if (target.classList.contains('media-delete-button')) {
            ...
            fetch(`https://v.qq.com/sheep/VidSheep/api/?deleteRecent=${mediaId}`)
                .then(response => response.json())
                .then(data => console.log(data.data.information));
        ...
        if (target.classList.contains('collect-delete-button')) {
            ...
            fetch(`https://v.qq.com/sheep/VidSheep/api/?collect=${mediaId}`)
                .then(response => response.json())
                .then(data => console.log(data.data.information));
        ...
        if (target.classList.contains('media-image') || target.classList.contains('media-title')) {
            ...
            if (mediaTag === 'locationsearch') {
                ...
                // 添加到最近记录
                fetch(`https://v.qq.com/sheep/VidSheep/api/?recent=${mediaId}`)
                    .then(response => response.json())
                    .then(data => console.log(data.data.information));
            }
...
discoverSection.addEventListener('click', (e) => {
    ...
    const handleDiscoverItem = {
        'discover-wallpaper': () => {
            ...
            // 获取壁纸数据
            fetch('https://v.qq.com/sheep/VidSheep/api/?wallpaper=get')
                .then(response => response.json())
                .then(data => {
...
// 请求用户信息测试
function userinfo() {
    fetch('https://v.qq.com/sheep/VidSheep/api/?userinfo=all')
        .then(response => response.json())
        .then(data => {
            console.log(data);
...
announcementNO.addEventListener("click", () => {
    ...
    fetch('https://v.qq.com/sheep/VidSheep/api/?announcement=1')
        .then(response => response.json())
        .then(data => {
            console.log(data.data.information);
        })
